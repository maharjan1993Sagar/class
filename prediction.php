...
{
    $innerJoinQuery = 'select * from users as u inner join predictions as p on u.id=p.user_id and p.id='.$predictId.' inner join matches as m on m.id=p.match_id';

    $result=selectData($innerJoinQuery);
